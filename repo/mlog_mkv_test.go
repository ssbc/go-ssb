...
func TestCatchLockedError(t *testing.T) {
	var input = []string{`failed to open KV: cannot access DB "testrun/TestRecoverFromCrash/sublogs/userFeeds/roaring/mkv": lock file "/home/cryptix/go/src/github.com/ssbc/go-ssb/cmd/go-sbot/testrun/TestRecoverFromCrash/sublogs/userFeeds/roaring/.3af2fe39bb7055138dbbafd36e23785d200b93cf" exists`,
	...
	//require.Equal(t, files[2], "/home/cryptix/go/src/github.com/ssbc/go-ssb/cmd/go-sbot/testrun/TestRecoverFromCrash/sublogs/userFeeds/roaring/.3af2fe39bb7055138dbbafd36e23785d200b93cf")
}
