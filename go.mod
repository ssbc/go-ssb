...
require (
	...
	github.com/keks/persist v0.0.0-20181029214439-3af502dad70b // indirect
	...
	go.cryptoscope.co/muxrpc v1.3.1-0.20190115152533-93deb6eb9aed
	...
	gonum.org/v1/gonum v0.0.0-20190110111800-20cf5b65417a
